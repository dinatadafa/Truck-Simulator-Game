//TUGAS BESAR GKV Game Simulasi Truk Gandeng
//Lab: B1
//Nama anggota:
//1. Dafa Kurnia Dinata (24060121120003)
//2. Iksan Nur Rochim (24060121120013)
//3. Thirafi Syahir Saputra (24060121140139)
//4. Prisca Della Budiman (24060121140093)
...
void init(void){
    glEnable (GL_DEPTH_TEST); // untuk mengaktifkan depth test
